					...
					<div class="card1">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
							<div class="card2">
								...
								<p id="info">
									<font color="blue"> Free of Cost</font>
								</p>
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
							<div class="card2">
								...
								<p id="info">
									<font color="blue"> Rs.13.50 per Kg.</font>
								</p>

								<p id="info">500 gms per head per month subject to a<font color="blue"> maximum of 2 kgs. per month.</font>
								</p>
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
							<div class="card2">
								...
								<p id="info">
									<font color="blue"> Rs.13.60 to
										Rs.14.20 per litre</font>
								</p>
